package com.delarosa.pushnotificationmvvm.model.database
...
class DataBaseHandler(context: Context) : SQLiteOpenHelper(
    ...
    fun insertData(notification: NotificationDto) {
    ...
    fun readData(): ArrayList<NotificationDto> {
        var list: ArrayList<NotificationDto> = ArrayList()
        val db = this.writableDatabase
        ...
        if (result.moveToFirst()) {
            do {
                ...
                var notification = NotificationDto(time, description)
